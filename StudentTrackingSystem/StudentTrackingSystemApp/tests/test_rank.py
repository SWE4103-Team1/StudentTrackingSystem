...
class RankTests(TestCase):
	def test_calculate_rank_fir(self):
		...
		self.assertTrue(calculateRank(student.id) == 'FIR')
	...
	def test_calculate_rank_jun(self):
		...
		self.assertTrue(calculateRank(student.id) == 'JUN')
	...
	def test_calculate_rank_sop(self):
		...
		self.assertTrue(calculateRank(student.id) == 'SOP')
	...
	def test_calculate_rank_sen(self):
		...
		self.assertTrue(calculateRank(student.id) == 'SEN')
